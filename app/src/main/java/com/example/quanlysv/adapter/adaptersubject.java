...
import com.example.quanlysv.ActivitySubject;
...
public class adaptersubject extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView TextViewSubjectTitle = view.findViewById(R.id.tvSbTt);
        TextView TextViewCredit = view.findViewById(R.id.tvCredit);
        ImageButton imageDelete = view.findViewById(R.id.sbdelete);
        ImageButton imageInformation = view.findViewById(R.id.sbinformation);
        ImageButton imageUpdate = view.findViewById(R.id.sbupdate);
